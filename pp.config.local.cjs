...
module.exports = {
  ...
  "engine": "puppeteer",
  "engineOptions": {
    "executablePath": "/Users/olgagulakevic/Desktop/my-projects/internship-landing/chrome/mac-143.0.7499.169/chrome-mac-x64/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing",
    "headless": "new",
    "args": [
      "--no-sandbox",
